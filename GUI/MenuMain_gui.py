...
def owner_login():
    ...
    with dpg.window(label="Owner Login", tag="Owner Login", width=300, height=200):
        ...
        dpg.add_button(label="Owner 1 (Vipps/Google/Own Log in)", tag="owner1LogInButton", callback=log_in_accepted,
                       user_data=owner_list[0])
        dpg.add_button(label="Owner 2 (Vipps/Google/Own Log in)", tag="owner2LogInButton", callback=log_in_accepted,
...
def renter_login():
    ...
    with dpg.window(label="Renter Login", tag="Renter Login", width=300, height=200):
        ...
        dpg.add_button(label="Renter 1 (Vipps/Google/Own Log in)", tag="renter1LogInButton", callback=log_in_accepted,
                       user_data=renter_list[0])
        dpg.add_button(label="Renter 2 (Vipps/Google/Own Log in)", tag="renter2LogInButton", callback=log_in_accepted,
